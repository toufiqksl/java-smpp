...
/**
 * A transmitter or transceiver ESME, wishing to submit a short
 ...
 */
public class SubmitSmPDU extends AbstractPDU {
	...
	public AbstractPDU createResponse() {
		SubmitSmRespPDU response = new SubmitSmRespPDU();
