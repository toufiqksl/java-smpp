 ...
 */
public class ReplaceSmRespPDU extends AbstractPDU {
     ...
     */
    public ReplaceSmRespPDU() {
    }

    /**
     * Returns Command ID for this PDU.
     *
     * @return PDU.REPLACE_SM_RESP;
     */
	...
	public AbstractPDU createResponse() {
		ReplaceSmPDU response = new ReplaceSmPDU();
    ...
    public boolean equals(Object o) {
    	boolean result;
    	if (o instanceof ReplaceSmRespPDU) {
    		ReplaceSmRespPDU p = (ReplaceSmRespPDU) o;
