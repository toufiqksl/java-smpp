...
/**
 * The MC response to a broadcast_sm PDU, indicating the success
 ...
 */
public class BroadcastSmRespPDU extends AbstractPDU {
     ...
     */
    public BroadcastSmRespPDU() {
    }

    /**
     * Returns Command ID for this PDU.
     *
     * @return PDU.BROADCAST_SM_RESP;
     */
    ...
    public boolean equals(Object o) {
    	boolean result;
    	if (o instanceof BroadcastSmRespPDU) {
    		BroadcastSmRespPDU p = (BroadcastSmRespPDU) o;
